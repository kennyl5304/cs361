...
public class DemoEmployee {
	...
	public static void main(String[] args) {
		...
		emp3.whoAmI();
		// TODO To complete
		 //emp3.whoAmI(); // prints "PART TIME EMPLOYEE" because it calls the whoAmI() method from the PartTimeEmployee class rather than the Employee class.
		 //emp3.getHourlyRate(); // returns syntax error because the method isn't defined in the Employee class.
		...
		// because the object (an instance of Employee) being downcast isn't an instance of the subclass (PartTimeEmployee)
